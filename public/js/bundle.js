...
window.addEventListener("load", function () {
  ...
  var bannerScrollHeight = banner ? banner.scrollHeight + 100 : 0;
  var observer = new IntersectionObserver(function (entry) {
    window.addEventListener("scroll", function () {
      return entry[0].isIntersecting ? headerRef.classList.remove("active") : headerRef.classList.add("active");
    });
    ...
    var handleScroll = function handleScroll() {
      ...
      currentScrollTop > bannerScrollHeight && currentScrollTop > lastScrollTop ? headerRef.classList.add("invisible") : headerRef.classList.remove("invisible");
